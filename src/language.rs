...
pub enum Language {
    #[strum(props(CarTypeOffset="0xAEBCD6C", CarPhysicsByCarTypeOffset="0xAEBB78C", CarPhysicsByTrackOffset="0xAEBBC1C"))]
    English,
    #[strum(props(CarTypeOffset="0xA", CarPhysicsByCarTypeOffset="0xBB", CarPhysicsByTrackOffset="0xCCC"))]
    TestLanguage
}
